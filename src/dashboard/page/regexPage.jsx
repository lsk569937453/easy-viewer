...
export function RegexPage() {
    ...
    const handleRegexInputOnChange = (t) => {
    ...
    return (<>
            <div className="flex flex-col h-[calc(100vh-30px)] gap-4">
                ...
                <div className="basis-8/12">
                    ...
                    <AceEditor ref={aceEditorRef} className="border-foreground/50 border rounded" width="100%" height="100%" placeholder={t('regexPage.testInputPlaceHolder')} mode="html" theme={theme === "dark" ? "monokai" : "github"} name="blah2" value={currentInput} onChange={handleValueChange} fontSize={16} editorProps={{ $blockScrolling: true }} wrapEnabled={true} showGutter={true} highlightActiveLine={true} setOptions={{
