...
export default function FormatJsonPage() {
    ...
    return (<div className="flex flex-col h-[calc(100vh-30px)]">
             <div className="basis-8/12  mb-10">
                ...
                <AceEditor className="border-foreground/50 border rounded" width="100%" height="100%" placeholder={t('formatToolsPage.formatInputPlaceHolder')} mode="json" theme={theme === "dark" ? "monokai" : "github"} name="blah2" value={currentInput} onChange={handleValueChange} fontSize={16} editorProps={{ $blockScrolling: true }} showPrintMargin={true} showGutter={true} highlightActiveLine={true} setOptions={{
