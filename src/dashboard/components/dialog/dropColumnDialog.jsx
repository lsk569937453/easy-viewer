...
const DropColumnDialog = ({ node }) => {
  const { toast } = useToast()

  const { showDropColumnDialog, setShowDropColumnDialog } = useContext(
  ...
  return (
    <Dialog open={showDropColumnDialog} onOpenChange={setShowDropColumnDialog}>
...
export default DropColumnDialog
