...
export function getIcon(iconType, node) {
    if (iconType === "mysql") {
        ...
        return (
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" className={`${node.children && node.children.length > 0 ? 'fill-emerald-500' : 'fill-slate-500'}`} viewBox="0 0 16 16">
    ...
    } else if (iconType === "views") {
        return (
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-baseline-density-medium"><path stroke="none" d="M0 0h24v24H0z" fill="none" /><path d="M4 20h16" /><path d="M4 12h16" /><path d="M4 4h16" /></svg>

        );
    } else if (iconType === "functions") {
        return (
