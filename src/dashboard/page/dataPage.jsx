    ...
    <div className="flex  h-full w-full flex-col	">
      ...
      <div className="flex h-8 flex-row bg-background">
        ...
        <Button
          className=" h-full"
          onClick={() =>
            currentPage != rows.length / pageCount &&
      ...
      <div
        ...
        style={{ height: tableHeight, overflow: showLoading ? "hidden" : "scroll" }}
        ref={setContainer}
      >
              <DataTable columns={header} data={rows} table={table} />

        <div
          className="lsk-dialog"
        ...
        >
          ...
          <div className="bg-ring absolute left-[50%] top-[50%] z-20 flex translate-x-[-50%] translate-y-[-50%] flex-row  border bg-background p-6 shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] sm:rounded-lg">
              <svg
