...
export default function DigestPage() {
    ...
    const handleSelectFileButtonClick = async () => {
        ...
        setSelectedFilePaths((prevState) => [...prevState, ...selected]);
    };
    ...
    const renderTable = () => {
        return digestResult.map((item, index) => {
            return <TableRow>
    ...
    return (<div className=" w-full h-[calc(100vh-30px)] flex flex-col">
