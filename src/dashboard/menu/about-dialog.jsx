...
export function AboutDialog() {
    ...
    return (<DialogContent className="overflow-clip pb-2">
      ...
      <DialogFooter className="flex flex-row items-center border-t pt-2 text-slate-400 ">
        <div className="mr-auto flex flex-row gap-2">
          <HomeIcon className="h-5 w-5 cursor-pointer transition hover:text-slate-300" onClick={() => open("https://github.com/lsk569937453/code-magic-public")}/>
          <GithubIcon className="h-5 w-5 cursor-pointer transition hover:text-slate-300 " onClick={() => open("https://github.com/lsk569937453/code-magic-public")}/>
        </div>
